...
# Cargar imagen
grayImg = cv2.imread('/mnt/Documents/images/lena.jpg', 0) # Se carga la imagen en escala de grises
CMin = 0  # Se define el valor mínimo deseado del histograma 
CMax = 100  # Se define el valor máximo deseado del histograma
